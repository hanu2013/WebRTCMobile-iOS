...
- (NSData *)JSONData {
    return
    [RTCIceCandidate JSONDataForIceCandidates:_candidates withType:kARDTypeValueRemoveCandidates];
}
...
- (instancetype)initWithDescription:(RTCSessionDescription *)description {
    ...
    switch (sdpType) {
        ...
        case RTCSdpTypePrAnswer:
            NSAssert(NO, @"Unexpected type: %@", [RTCSessionDescription stringForType:sdpType]);
            break;
    }
