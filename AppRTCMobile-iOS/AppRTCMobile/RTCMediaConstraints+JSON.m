...
+ (RTCMediaConstraints *)constraintsFromJSONDictionary: (NSDictionary *)dictionary {
    ...
    NSMutableDictionary *mandatoryContraints = [NSMutableDictionary dictionaryWithCapacity:[mandatory count]];
    [mandatory enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
